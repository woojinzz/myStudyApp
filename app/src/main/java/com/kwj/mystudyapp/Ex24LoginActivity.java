...
public class Ex24LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ex24_login);
        //id연동
        ...
        tvJoin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent1 = new Intent(Ex24LoginActivity.this, Ex1JoinActivity.class);
    ...
    void dataTest1()
    {
        ...
        Toast.makeText(Ex24LoginActivity.this,
                "아이디:"+id+" / 비번:"+pw,
...
//        Log.d("로그인화면","아이디:"+id+" / 비번:"+pw);
        ...
        Intent intent1 =
                new Intent(Ex24LoginActivity.this, Ex1JoinActivity.class);
        startActivity(intent1);
    }
